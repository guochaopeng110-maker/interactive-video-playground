...
<required_reading>
Read `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
