...
Reference full template: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/state.md`.
