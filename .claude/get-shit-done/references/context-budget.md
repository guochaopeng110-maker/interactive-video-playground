...
The keys live in `.claude/settings.json` (project) or `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/settings.json` (global) — **not** in `.planning/config.json`:
