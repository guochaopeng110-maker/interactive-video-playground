...
See F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/discovery.md
...
Use F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/discovery.md.
