...
```
Agent(
  prompt="Read F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/SECURITY.md`
