...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/agents/gsd-ui-checker.md for instructions.
