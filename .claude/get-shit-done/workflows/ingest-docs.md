...
```bash
INIT=$(node "F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
