...
```bash
INIT=$(node "F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/templates/spec.md.
