...
INSTALL_JS_GLOBAL="F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
