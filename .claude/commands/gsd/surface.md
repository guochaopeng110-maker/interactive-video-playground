...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/.gsd-surface.json`
(sibling to `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/skills`).
...
`F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/.gsd-surface.json`
Install profile marker: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/.gsd-profile`
Skill dirs: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/skills/gsd-*/`
Engine module: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/Projects/Interective-Video/InteractiveVideoDemo/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
