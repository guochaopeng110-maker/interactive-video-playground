...
The keys live in `.codex/settings.json` (project) or `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/settings.json` (global) — **not** in `.planning/config.json`:
