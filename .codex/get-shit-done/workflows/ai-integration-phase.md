...
<required_reading>
@F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/ai-frameworks.md
@F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-eval-planner.md for instructions.
