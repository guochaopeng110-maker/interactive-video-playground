...
Key references:
- @F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md" "F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/AGENTS.md
```
