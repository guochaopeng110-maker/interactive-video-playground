...
```
Agent(
  prompt="Read F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/templates/SECURITY.md`
