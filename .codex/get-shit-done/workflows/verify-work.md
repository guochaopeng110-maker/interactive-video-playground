...
<template>
@F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/workflows/diagnose-issues.md
