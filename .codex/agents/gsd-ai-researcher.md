...
<required_reading>
Read `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
