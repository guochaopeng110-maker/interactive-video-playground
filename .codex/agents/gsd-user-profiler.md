...
<reference>
@F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `F:/Projects/Interective-Video/InteractiveVideoDemo/.codex/get-shit-done/references/user-profiling.md` to load:
